...
<s:form action="saveConfig" namespace="/do/jpattendee/Attendee/Page/SpecialWidget/jpattendeeAttendeeConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select cssClass="form-control" list="attendeesId" name="id" id="id" cssClass="form-control" />
